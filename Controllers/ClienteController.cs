...
namespace ProjetoBancoDados.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ClienteId,ClienteNome,ClienteCpf,ClientePassaporte,ClienteTelefone,ClienteEmail,ClienteNascimento")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClienteId,ClienteNome,ClienteCpf,ClientePassaporte,ClienteTelefone,ClienteEmail,ClienteNascimento")] Cliente cliente)
        {
