...
namespace ProjetoBancoDados.Controllers
{
    public class PagamentoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PagamentoId,PagamentoNome")] Pagamento pagamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PagamentoId,PagamentoNome")] Pagamento pagamento)
        {
