...
namespace ProjetoBancoDados.Controllers
{
    public class TransporteController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TransporteId,TransporteNome,TransporteAno,TransportePlaca")] Transporte transporte)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TransporteId,TransporteNome,TransporteAno,TransportePlaca")] Transporte transporte)
        {
        ...
        {
          return (_context.Transporte?.Any(e => e.TransporteId == id)).GetValueOrDefault();
        }
    }
}
